...
{
{text = ''..(channel_ts or "TshAkE TEAM")..'', url=''..(channel_user_ts or 't.me/MaksekoTEaM')..''},
},
}
...
local url , res = https.request("https://api.telegram.org/bot"..token.."/getchatmember?chat_id=@MaksekoTEaM&user_id="..msg.sender_user_id_);
...
------------------------------------------------------------------------
if (text == "قفل الصوت بالتحذير") then
...
------------------------------------------------------------------------
if (text == "قفل العربيه بالتحذير") then
...
tsX000("lock",msg,"☑️┇تم فتح الاغاني التحذير\n📛┇خاصية ~⪼ التحذير")
database:del("lock_audeo:wern"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "فتح الصوت بالتحذير") then
local tsX_o = database:get("lock_voice:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم فتح الصوت\n📛┇خاصية ~⪼ التحذير")
else
...
------------------------------------------------------------------------
if (text == "فتح العربيه بالتحذير") then
local tsX_o = database:get("lock_ar:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم فتح العربيه\n📛┇خاصية ~⪼ التحذير")
else
...
--------------------------------------------------------------------------------
if text == ("اعدادات التحذير") then
if database:get("lock_chat:wern"..msg.chat_id_..bot_id) then
 mute_text = '✔┇'
else
 mute_text = '✖┇'
 end
...
if database:get("lock_note:wern"..msg.chat_id_..bot_id) then
 mute_note = '✔┇'
else
 mute_note = '✖┇'
 end
...
if database:get("lock_audeo:wern"..msg.chat_id_..bot_id) then
 ...
 ------------
if database:get("lock_inline:wern"..msg.chat_id_..bot_id) then
 mute_in = '✔┇'
else
 mute_in = '✖┇'
 end
...
if database:get("lock_mark:wern"..msg.chat_id_..bot_id) then
 mute_mdd = '✔┇'
else
 mute_mdd = '✖┇'
 end
...
tsX000("lock",msg,"☑️┇تم فتح الاغاني الطرد\n🚫┇خاصية ~⪼ الطرد")
database:del("lock_audeo:ban"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "فتح الصوت بالطرد") then
local tsX_o = database:get("lock_voice:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم فتح الصوت\n🚫┇خاصية ~⪼ الطرد")
else
...
------------------------------------------------------------------------
if (text == "فتح العربيه بالطرد") then
local tsX_o = database:get("lock_ar:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم فتح العربيه\n🚫┇خاصية ~⪼ الطرد")
else
...
--------------------------------------------------------------------------------
if text == ("اعدادات الطرد") then
if database:get("lock_chat:ban"..msg.chat_id_..bot_id) then
 mute_text = '✔┇'
else
 mute_text = '✖┇'
 end
...
if database:get("lock_note:ban"..msg.chat_id_..bot_id) then
 mute_note = '✔┇'
else
 mute_note = '✖┇'
 end
...
if database:get("lock_audeo:ban"..msg.chat_id_..bot_id) then
 ...
 ------------
if database:get("lock_inline:ban"..msg.chat_id_..bot_id) then
 mute_in = '✔┇'
else
 mute_in = '✖┇'
 end
...
if database:get("lock_mark:ban"..msg.chat_id_..bot_id) then
 mute_mdd = '✔┇'
else
 mute_mdd = '✖┇'
 end
...
👩‍🚒┇[قناة البوت](t.me/MaksekoTEaM)

📮┇[لـ شراء نسخه من سورس ](t.me/YYBYYBOT)

]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
------------------------------------------------------------------------
if text == ("اريد رابط حذف") or text == ("رابط حذف") or text == ("رابط المسح") or text == ("الرابط حذف") or text == ("اريد رابط المسح") then
local url , res = https.request("https://api.telegram.org/bot"..token.."/getchatmember?chat_id=@MaksekoTEaM&user_id="..msg.sender_user_id_);
data = JSON.decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
send(msg.chat_id_, msg.id_, 1,'\n• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• @MaksekoTEaM ⚜️\n', 1, 'html')   
