...
zain = zain .. '&reply_to_message_id=' .. reply_to_message_id/2097152/0.5 -- جميع الحقوق محفوظه لفريق مكسيكو لايمكنك نسخ او استخدام هذه السطر بدون موافقه الفريق
end
...
if (text == "قفل التاك بالطرد بالطرد") then
local tsX_o = database:get("lock_tag:ban"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل التاك بالطرد\n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل التاك بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الشارحه بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الشارحه بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الكلايش بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الكلايش بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل المتحركه بالطرد\n🚫┇خاصية ~⪼ الطرد ")
else
tsX000("lock",msg,"☑┇ تم قفل المتحركه بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الملفات بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الملفات بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الماركدون بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الماركدون بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الصور بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الصور بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الملصقات بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الملصقات بالطرد\n🚫┇خاصية ~⪼ الطرد ")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الفيديو بالطرد\n🚫┇خاصية ~⪼ الطرد ")
else
tsX000("lock",msg,"☑┇ تم قفل الفيديو بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الانلاين بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الانلاين بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الدردشه بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الدردشه بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل التوجيه بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل التوجيه بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل التثبيت بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل التثبيت بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الاغاني بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الاغاني بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الجهات بالطرد\n🚫┇خاصية ~⪼ الطرد ")
else
tsX000("lock",msg,"☑┇ تم قفل الجهات بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الانكليزيه بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الانكليزيه بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الروابط بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل الروابط بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل المعرف بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇ تم قفل المعرف بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
local tsX_o = database:get("lock_tag:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح التاك بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح التاك بالطرد \n🚫┇خاصية ~⪼ الطرد")
database:del("lock_tag:ban"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_word:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الكلايش بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح الكلايش بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
local tsX_o = database:get("lock_sarha:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الشارحه بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح الشارحه بالطرد \n🚫┇خاصية ~⪼ الطرد")
database:del("lock_sarha:ban"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_gif:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح المتحركه بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح المتحركه بالطرد \n🚫┇خاصية ~⪼ الطرد")
database:del("lock_gif:ban"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_files:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الملفات بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح الملفات بالطرد \n🚫┇خاصية ~⪼ الطرد")
database:del("lock_files:ban"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_mark:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الماركدون بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح الماركدون بالطرد \n🚫┇خاصية ~⪼ الطرد")
database:del("lock_mark:ban"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_photo:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الصور بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح الصور بالطرد \n🚫┇خاصية ~⪼ الطرد")
database:del("lock_photo:ban"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_stecker:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الملصقات بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح الملصقات بالطرد \n🚫┇خاصية ~⪼ الطرد")
database:del("lock_stecker:ban"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_video:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الفيديو بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح الفيديو بالطرد \n🚫┇خاصية ~⪼ الطرد")
database:del("lock_video:ban"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_inline:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الانلاين بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح الانلاين بالطرد \n🚫┇خاصية ~⪼ الطرد")
database:del("lock_inline:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "فتح الدردشه بالطرد") then
local tsX_o = database:get("lock_chat:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الدردشه بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح الدردشه بالطرد \n🚫┇خاصية ~⪼ الطرد")
database:del("lock_chat:ban"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "فتح التوجيه بالطرد") then
local tsX_o = database:get("lock_fwd:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح التوجيه بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح التوجيه بالطرد \n🚫┇خاصية ~⪼ الطرد")
database:del("lock_fwd:ban"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_pin:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح التثبيت بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح التثبيت بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
local tsX_o = database:get("lock_audeo:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الاغاني بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح الاغاني بالطرد \n🚫┇خاصية ~⪼ الطرد")
database:del("lock_audeo:ban"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_contact:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الجهات بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح الجهات بالطرد \n🚫┇خاصية ~⪼ الطرد")
database:del("lock_contact:ban"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_en:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الانكليزيه بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح الانكليزيه بالطرد \n🚫┇خاصية ~⪼ الطرد")
...
local tsX_o = database:get("lock_username:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح المعرف بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح المعرف بالطرد \n🚫┇خاصية ~⪼ الطرد")
database:del("lock_username:ban"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_link:ban"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الروابط بالطرد \n🚫┇خاصية ~⪼ الطرد")
else
tsX000("lock",msg,"☑┇تم فتح الروابط بالطرد \n🚫┇خاصية ~⪼ الطرد")
database:del("lock_link:ban"..msg.chat_id_..bot_id,"ok")
end
end
...
--------Lock--wern-------
if is_devzain(msg) or is_sudo(msg) or is_creatorbasic(msg) or is_creatorbasicc(msg.chat_id_,msg.sender_user_id_) or is_creator(msg) or is_owner(msg) or is_mod(msg) then
if (text == "قفل التاك بالتحذير بالتحذير") then
local tsX_o = database:get("lock_tag:wern"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل التاك بالتحذير\n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل التاك بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الشارحه بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الشارحه بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الكلايش بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الكلايش بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل المتحركه بالتحذير\n📛┇خاصية ~⪼ التحذير ")
else
tsX000("lock",msg,"☑┇ تم قفل المتحركه بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الملفات بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الملفات بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الماركدون بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الماركدون بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الصور بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الصور بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الملصقات بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الملصقات بالتحذير\n📛┇خاصية ~⪼ التحذير ")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الفيديو بالتحذير\n📛┇خاصية ~⪼ التحذير ")
else
tsX000("lock",msg,"☑┇ تم قفل الفيديو بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الانلاين بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الانلاين بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الدردشه بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الدردشه بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل التوجيه بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل التوجيه بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل التثبيت بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل التثبيت بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الاغاني بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الاغاني بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الجهات بالتحذير\n📛┇خاصية ~⪼ التحذير ")
else
tsX000("lock",msg,"☑┇ تم قفل الجهات بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الانكليزيه بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الانكليزيه بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل الروابط بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل الروابط بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
if tsX_o then
tsX000("lock",msg,"☑┇ بالفعل تم قفل المعرف بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇ تم قفل المعرف بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
local tsX_o = database:get("lock_tag:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح التاك بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح التاك بالتحذير \n📛┇خاصية ~⪼ التحذير")
database:del("lock_tag:wern"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_word:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الكلايش بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح الكلايش بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
local tsX_o = database:get("lock_sarha:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الشارحه بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح الشارحه بالتحذير \n📛┇خاصية ~⪼ التحذير")
database:del("lock_sarha:wern"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_gif:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح المتحركه بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح المتحركه بالتحذير \n📛┇خاصية ~⪼ التحذير")
database:del("lock_gif:wern"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_files:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الملفات بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح الملفات بالتحذير \n📛┇خاصية ~⪼ التحذير")
database:del("lock_files:wern"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_mark:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الماركدون بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح الماركدون بالتحذير \n📛┇خاصية ~⪼ التحذير")
database:del("lock_mark:wern"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_photo:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الصور بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح الصور بالتحذير \n📛┇خاصية ~⪼ التحذير")
database:del("lock_photo:wern"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_stecker:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الملصقات بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح الملصقات بالتحذير \n📛┇خاصية ~⪼ التحذير")
database:del("lock_stecker:wern"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_video:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الفيديو بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح الفيديو بالتحذير \n📛┇خاصية ~⪼ التحذير")
database:del("lock_video:wern"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_inline:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الانلاين بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح الانلاين بالتحذير \n📛┇خاصية ~⪼ التحذير")
database:del("lock_inline:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "فتح الدردشه بالتحذير") then
local tsX_o = database:get("lock_chat:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الدردشه بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح الدردشه بالتحذير \n📛┇خاصية ~⪼ التحذير")
database:del("lock_chat:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "فتح التوجيه بالتحذير") then
local tsX_o = database:get("lock_fwd:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح التوجيه بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح التوجيه بالتحذير \n📛┇خاصية ~⪼ التحذير")
database:del("lock_fwd:wern"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_pin:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح التثبيت بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح التثبيت بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
local tsX_o = database:get("lock_audeo:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الاغاني بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح الاغاني بالتحذير \n📛┇خاصية ~⪼ التحذير")
database:del("lock_audeo:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "فتح الصوت") then
...
local tsX_o = database:get("lock_contact:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الجهات بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح الجهات بالتحذير \n📛┇خاصية ~⪼ التحذير")
database:del("lock_contact:wern"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "فتح العربيه") then
...
local tsX_o = database:get("lock_en:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الانكليزيه بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح الانكليزيه بالتحذير \n📛┇خاصية ~⪼ التحذير")
...
local tsX_o = database:get("lock_username:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح المعرف بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح المعرف بالتحذير \n📛┇خاصية ~⪼ التحذير")
database:del("lock_username:wern"..msg.chat_id_..bot_id,"ok")
end
end
...
local tsX_o = database:get("lock_link:wern"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم فتح الروابط بالتحذير \n📛┇خاصية ~⪼ التحذير")
else
tsX000("lock",msg,"☑┇تم فتح الروابط بالتحذير \n📛┇خاصية ~⪼ التحذير")
database:del("lock_link:wern"..msg.chat_id_..bot_id,"ok")
end
end
...
------------------------------------------------------------------------
if (text and text == (redis:get('Tshake:'..bot_id..'name_bot') or 'مكسيكو'))then
name_bot = (redis:get('Tshake:'..bot_id..'name_bot') or 'مكسيكو')
local namebot = {
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📌┇مكسيكو + شنو رئيك بهذا
📌┇مكسيكو + شنو رئيك بهاي
📌┇مكسيكو + هينه
📌┇مكسيكو + رزله
📌┇مكسيكو + بوسه
📌┇مكسيكو + مصه
...
local Name_Bot = (redis:get('Tshake:'..bot_id..'name_bot') or 'مكسيكو')
